    ...
    return (
        ...
        <div className="relative hidden w-1/2 flex-col items-center justify-center overflow-hidden bg-ink lg:flex">
            ...
            <div className="h-24 w-12 bg-teal" />
            <div className="h-32 w-12 bg-amber" />
            <div className="h-20 w-12 bg-coral" />
            <div className="h-36 w-12 bg-parchment/40" />
            <div className="h-28 w-12 bg-teal/60" />
            </div>
        ...
        <div className="flex w-full flex-col items-center justify-center bg-parchment px-6 py-12 lg:w-1/2">
            ...
            <h2 className="mb-1 text-2xl font-medium text-ink">Welcome back</h2>
